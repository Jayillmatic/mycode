...
print("Priinting outone item from the list, using INDEX 1...")
print("Remember that index 1 is the 2nd item in the list")
print(list1[1])
print()

# Extend the list, by adding a list only containing Juniper
#list1.extend(['juniper']) # comment this line out to demostate code line below (uncomment line below to demo)
...
# print("Print out the list, with the juniper string extended to the original list")
# print(list1)
# print()
